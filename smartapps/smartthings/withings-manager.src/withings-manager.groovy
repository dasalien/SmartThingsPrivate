...
def wLogEnabled() { true } // For troubleshooting Oauth flow false
...
def userAuthorizationUrl() {
    ...
    log.debug "WITHINGS OAUTH STEP 1: get an oAuth 'request token': ${tokenUrl}"
	...
	def uAuthUrl = buildOauthUrl("https://oauth.withings.com/account/authorize", paramStrings, oauth_token_secret())
    log.debug "WITHINGS OAUTH STEP 2: End-user authorization: ${uAuthUrl}"
