 ...
 * Adapted from (name: "Pentair Controller", namespace: "dhopson", author: "David Hopson", oauth: true)
 */
...
metadata {
	definition (name: "Pentair Pool Controller V2", namespace: "dasalien", author: "Dieter Rothhardt", oauth: true) {
        //capability
        capability "Switch"
    	capability "Polling"        
        capability "Refresh"
    ...
    preferences {
       	section("Select your controller") {
            ...
            input "username", type:"text", title:"Username", description: "username", required: false, displayDuringSetup: true
            input "password", type:"password", title:"Password", description: "Password", required: false, displayDuringSetup: true, hidden: true
            }
         section("schedules") {   
            ...
            input name: "sch_start", type: "time", title: "Schedule Start Time", description: "Start Time for schedule", required: false
            input name: "sch_end",   type: "time", title: "Schedule End Time",   description: "End Time for schedule",   required: false             
	...
	tiles(scale: 2) {
		...
		standardTile("Main", "device.POOL", width: 2, height: 2, canChangeBackground: true) {
        	state "unknown", label: '---', action: "actionUnknown", icon: "https://eeddir.github.io/smartthings/h2.png",  backgroundColor: "#F2F200"
			state "off", label: 'Off', action:"pumpToggle", icon: "https://eeddir.github.io/smartthings/h2.png", nextState: "on", backgroundColor: "#ffffff"
			state "on", label: 'On', action:"pumpToggle", icon: "https://eeddir.github.io/smartthings/h2.png", nextState: "off", backgroundColor: "#79b821"
		}
        
        standardTile("debug", "device.debug", width: 2, height: 2, canChangeBackground: true) {
        	state "on", label:'Debug ${currentValue}', action:"set_debug", nextState: "off", backgroundColor: "#79b821", defaultState: false
            state "off", label:'Debug ${currentValue}', action:"set_debug", nextState: "on", backgroundColor: "#ffffff", defaultState: true
    	}  
        valueTile("poolspace", "device.poolspace", width: 4, height: 2, decoration: "flat", canChangeBackground: false) {
            state "val", label:'POOL MODE', action:"", defaultState: true//, backgroundColor: "#00a0dc"
		} 
        valueTile("spaspace", "device.spaspace", width: 4, height: 2, decoration: "flat", canChangeBackground: false) {
            state "val", label:'SPA MODE', action:"", defaultState: true//, backgroundColor: "#00a0dc"
		}        
        ...
        standardTile("freeze", "device.freeze", width:2, height: 2, canChangeBackground: false, decoration: "flat") {  
        	state "on", label:'Freeze', defaultState: false, nextState: "off", backgroundColor: "#bc2323", icon: "https://eeddir.github.io/smartthings/w8.png" //, action: "noAction"
            state "off", label:'No Freeze', defaultState: true, nextState: "on", backgroundColor: "#ffffff", icon: "https://eeddir.github.io/smartthings/w14.png" //, action: "noAction" //ffffff
        }        
        standardTile("config", "device.config", width:2, height: 2, canChangeBackground: false, decoration: "flat") {  
            state "unknown", label: 'Updating', defaultState: true, backgroundColor: "#F2F200"
        	state "on", label:'Ready', defaultState: false, nextState: "off", backgroundColor: "#79b821" //, action: "noAction"
            state "off", label:'Not Ready', defaultState: true, nextState: "on", backgroundColor: "#bc2323" //, action: "noAction"
        }         
                        
        // Air, Pool and Spa Temperature
        //////////////////////////////////////////////////      
        valueTile("airTemp",  "device.airTemp",  width: 2, height: 2, canChangeBackground: true) {
        	state("temperature", label:'${currentValue}°', icon: "https://eeddir.github.io/smartthings/w2.png", 
            backgroundColors:[
        ...
        valueTile("poolTemp", "device.poolTemp", width: 2, height: 2, canChangeBackground: true) { 
        	state("temperature", label:'${currentValue}°', icon: "https://eeddir.github.io/smartthings/h2.png", 
            backgroundColors:[
                [value: 31, color: "#153591"],
                [value: 44, color: "#1e9cbb"],
                [value: 59, color: "#90d2a7"],
        ...
        valueTile("poolTemp4", "device.poolTemp4", width: 2, height: 2, canChangeBackground: true) { 
        	state("temperature", label:'Heat To: ${currentValue}°', icon: "https://eeddir.github.io/smartthings/h2.png" /*, 
            backgroundColors:[
                [value: 31, color: "#153591"],
                [value: 44, color: "#1e9cbb"],
                [value: 59, color: "#90d2a7"],
        ...
        valueTile("spaTemp",  "device.spaTemp",  width: 2, height: 2, canChangeBackground: true) {
        	state("temperature", label:'${currentValue}°',decoration: "flat", icon: "https://eeddir.github.io/smartthings/spa.png", //icon: "https://eeddir.github.io/smartthings/b4.png", 
            backgroundColors:[
                [value: 31, color: "#153591"],
                [value: 44, color: "#1e9cbb"],
                [value: 59, color: "#90d2a7"],
        ...
        valueTile("spaTemp4", "device.spaTemp4", width: 2, height: 2, canChangeBackground: true) { 
        	state("temperature", label:'Heat To: ${currentValue}°', icon: "https://eeddir.github.io/smartthings/spa.png" /*, //icon: "https://eeddir.github.io/smartthings/b4.png" /*, 
            backgroundColors:[
                [value: 31, color: "#153591"],
                [value: 44, color: "#1e9cbb"],
                [value: 59, color: "#90d2a7"],
        ...
        standardTile("POOL LIGHT", "device.POOL LIGHT", width: 2, height: 2, canChangeBackground: true) {
            state "off", label: 'Pool', action: "poolLightToggle", icon: "https://eeddir.github.io/smartthings/l13.png", backgroundColor: "#ffffff", nextState: "on"
			state "on", label: 'Pool', action: "poolLightToggle", icon: "https://eeddir.github.io/smartthings/l11.png", backgroundColor: "#79b821", nextState: "off"
		}
        standardTile("SPA LIGHT", "device.SPA LIGHT",   width: 2, height: 2, canChangeBackground: true) {
			state "off", label: 'Spa', action: "spaLightToggle", icon: "https://eeddir.github.io/smartthings/l13.png", backgroundColor: "#ffffff", nextState: "on"
			state "on", label: 'Spa', action: "spaLightToggle", icon: "https://eeddir.github.io/smartthings/l11.png", backgroundColor: "#79b821", nextState: "off"
		}        
        standardTile("ALL LIGHTS", "device.ALL LIGHTS",   width: 2, height: 2, canChangeBackground: true) {
        	state "half", label: 'All', action: "allLightToggle", icon: "https://eeddir.github.io/smartthings/l21.png", backgroundColor: "#F2F200", nextState: "off"
			state "off", label: 'All', action: "allLightToggle", icon: "https://eeddir.github.io/smartthings/l21.png", backgroundColor: "#ffffff", nextState: "on", defaultState: true
			state "on", label: 'All', action: "allLightToggle", icon: "https://eeddir.github.io/smartthings/l21.png", backgroundColor: "#79b821", nextState: "off", defaultState: false
		}  
        standardTile("CLEANER", "device.CLEANER", width: 2, height: 2, canChangeBackground: true) {
        	state "unknown", label: 'Cleaner', action: "cleanerUnknown", icon: "https://eeddir.github.io/smartthings/w1.png", backgroundColor: "#F2F200"
			state "off", label: 'Cleaner', action: "cleanerToggle", icon: "https://eeddir.github.io/smartthings/w1.png", backgroundColor: "#ffffff", nextState: "on"
			state "on", label: 'Cleaner', action: "cleanerToggle", icon: "https://eeddir.github.io/smartthings/w1.png", backgroundColor: "#79b821", nextState: "off"
		}
        // Runs Pool filter & if phm > 0 then pool is heated
        standardTile("POOL", "device.POOL", width: 2, height: 2, canChangeBackground: true) {
        	state "unknown", label: 'Pump', action: "pumpUnknown", icon: "st.samsung.da.RC_ic_power", backgroundColor: "#F2F200"
			state "off", label: 'Pump', action: "pumpToggle", icon: "st.samsung.da.RC_ic_power", backgroundColor: "#ffffff", nextState: "on"
			state "on", label: 'Pump', action: "pumpToggle", icon: "st.samsung.da.RC_ic_power", backgroundColor: "#79b821", nextState: "off"
		}
        //////////////////////////////////////////////////
        // HeatingSetpoint
        ...
        standardTile("SPA", "device.SPA", width: 2, height: 2, canChangeBackground: true) {
        	state "unknown", label: 'Spa', action: "spaUnknown", icon: "https://eeddir.github.io/smartthings/h29.png", backgroundColor: "#F2F200"
			state "off", label: 'Spa', action: "spaToggle", backgroundColor: "#ffffff", nextState: "on", icon: "https://eeddir.github.io/smartthings/spa.png" //, icon: "https://eeddir.github.io/smartthings/h29.png" //,icon: "http://cdn.device-icons.smartthings.com/st.thermostat.heat"
			state "on", label: 'Spa', action: "spaToggle", backgroundColor: "#79b821", nextState: "off", icon: "https://eeddir.github.io/smartthings/spa.png" //, icon: "https://eeddir.github.io/smartthings/h29.png" //,icon: "http://cdn.device-icons.smartthings.com/st.thermostat.heating"
        }     
        ...
        standardTile("POOLHEAT", "device.POOLHEAT", width: 2, height: 2, canChangeBackground: true) {
        	state "unknown", label: 'Pool', action: "poolUnknown", backgroundColor: "#F2F200"
			state "off", label: 'Pool', action: "poolHeatToggle", backgroundColor: "#ffffff", nextState: "on", defaultState: true, icon: "https://eeddir.github.io/smartthings/h2.png"
			state "on", label: 'Pool', action: "poolHeatToggle", backgroundColor: "#79b821", nextState: "off", icon: "https://eeddir.github.io/smartthings/h2.png"
        }     
        ...
        standardTile("poolHeatMode", "device.poolHeatMode", width:2, height: 2, canChangeBackground: true) {
            state "Off", label: 'Pool Heater Off', action: "poolModeToggle", backgroundColor: "#ffffff", nextState: "Heater"//, icon: "https://eeddir.github.io/smartthings/h29.png"
			state "Heater", label: 'Heater', action: "poolModeToggle", backgroundColor: "#00a0dc", nextState: "Off", icon: "https://eeddir.github.io/smartthings/h29.png"
            //state "Heater", label: '${name}', action: "poolModeToggle", backgroundColor: "#00a0dc", nextState: "Solar Pref", icon: "https://eeddir.github.io/smartthings/h29.png"
			//state "Solar Pref", label: '${name}', action: "poolModeToggle", backgroundColor: "#e86d13", nextState: "Solar Only", icon: "https://eeddir.github.io/smartthings/h29.png"
			//state "Solar Only", label: '${name}', action: "poolModeToggle", backgroundColor: "#f1d801", nextState: "Off", icon: "shttps://eeddir.github.io/smartthings/h29.png"
  
        }
        standardTile("spaHeatMode", "device.spaHeatMode", width:2, height: 2, canChangeBackground: true) {
            state "Off", label: 'Spa Heater Off', action: "spaModeToggle", backgroundColor: "#ffffff", nextState: "Heater"//, icon: "https://eeddir.github.io/smartthings/h29.png"
			state "Heater", label: 'Heater', action: "spaModeToggle", nextState: "Off", backgroundColor: "#00a0dc", icon: "https://eeddir.github.io/smartthings/h29.png"
			//state "Heater", label: '${currentValue}', action: "spaModeToggle", nextState: "Solar Pref", backgroundColor: "#00a0dc", icon: "https://eeddir.github.io/smartthings/h29.png"
            //state "Solar Pref", label: '${currentValue}', action: "spaModeToggle", backgroundColor: "#e86d13", nextState: "Solar Only", icon: "https://eeddir.github.io/smartthings/h29.png"
			//state "Solar Only", label: '${currentValue}', action: "spaModeToggle", backgroundColor: "#f1d801", nextState: "Off", icon: "https://eeddir.github.io/smartthings/h29.png"
        }
        ...
        //////////////////////////////////////////////////        
 		multiAttributeTile(name:"thermostatFullspa", type:"thermostat", width:6, height:4) {
            ...
            tileAttribute("device.spaTemp", key: "PRIMARY_CONTROL", canChangeBackground: true) {
                attributeState("spatemp", label:'${currentValue}°', unit:"dF", defaultState: true, icon: "https://eeddir.github.io/smartthings/b4.png")
    		}
        ...
        multiAttributeTile(name:"thermostatFullpool", type:"generic", width:6, height:4) {
    		...
    		tileAttribute("device.poolTemp", key: "PRIMARY_CONTROL") {
        		attributeState("pooltemp", label:'${currentValue}°', unit:"dF", defaultState: true, icon: "https://eeddir.github.io/smartthings/health2-icn@2x.png",
        ...
        controlTile("poolLevelSliderControl", "device.poolTemp4", "slider", height: 2, width: 2, range:"(20..105)", inactiveLabel: false, label: "Pool Temperature") {
           state "pooltemperature", action:"poolSetRangedLevel"
        }
        controlTile("spaLevelSliderControl", "device.spaTemp4", "slider", height: 2, width: 2, range:"(20..105)", inactiveLabel: false, label: "SPA Temperature") {
           state "spatemperature", action:"spaSetRangedLevel"
        }
        //////////////////////////////////////////////////         
        
        valueTile("scheduleTile", "device.scheduleTile", width: 6, height: 6, decoration: "flat", canChangeBackground: false) {
        ...
        standardTile("addscheduleTile", "device.addschedule", width: 3, height:2, canChangeBackground: true) {
        ...
        valueTile("eggTimerSchedule", "device.eggTimerSchedule", width:6, height: 2, canChangeBackground: false) {
        	state "on", label: '${currentValue}', nextState: "off"
            state "off", label: '${currentValue}', nextState: "on"
        }        
        standardTile("delscheduleTile", "device.delschedule", width: 3, height: 2, canChangeBackground: true) {
		...
		standardTile("chlorinate", "device.chlorinate", width:2, height:1, inactiveLabel: false, decoration: "flat") {
			state "off",  action:"chlorinatorOn", nextState: "updating", icon: "https://eeddir.github.io/smartthings/chlorine.png",backgroundColor: "#ffffff"
			state "on", action:"chlorinatorOff",  nextState: "updating", icon: "https://eeddir.github.io/smartthings/chlorine.png",backgroundColor: "#00a0dc"
        ...
        valueTile("saltPPM", "saltPPM",width:1, height:1, decoration:"flat") {
            state("saltPPM", label:'${currentValue}',
				backgroundColors:[							
							...
							[value: 2400, color: "#bc2323"],
							[value: 2800, color: "#d04e00"],
							[value: 3000, color: "#F1D801"],
							[value: 3200, color: "#44B621"],
                            [value: 3600, color: "#F1D801"],
                            [value: 3800, color: "#d04e00"],
                            [value: 4000, color: "#bc2323"]
                     ]
				)
			}        
        ...
        valueTile("poolSpaSetpoint","poolSpaSetpoint",width:2, height:1, decoration:"flat")  {
        ...
        valueTile("status","status",width:5, height:1, decoration:"flat")  {
        ...
        "spaLevelSliderControl","spaTemp4","spaHeatMode",
        
        "poolspace","POOLHEAT",
        
        "poolLevelSliderControl","poolTemp4","poolHeatMode", 
        
        "chlorinate","saltPPM","currentOutput","poolSpaSetpoint","status","superChlorinate",
...
def parseMain(physicalgraph.device.HubResponse hubResponse) {
   log.debug "------------- parseMain -------------"  
...
def processJSON(json) {
    ...
    if (!json) {
       ...
       return evt
        ...
        //log.info "json = ${json}"
        //log.debug("parse - config =/n ${json.config}")
        //log.debug("parse - circuit =/n ${json.circuit}")
        //log.debug("parse - saltPPM =/n ${json.saltPPM}")
        //log.debug("parse - chlorinator =/n ${json.chlorinator}")
        //log.debug("parse - schedule =/n ${json.schedule}")
        log.debug("parse - temperature =/n ${json.temperature}")
		log.debug("parse - valves =/n ${json.valves}")
        //log.debug("parse - UOM =/n ${json.UOM}")
        //log.debug("parse - pump =/n ${json.pump}")
        //log.debug("parse - time =/n ${json.time}")
    	...
    	//state.lightCircuits = mesg.config.equipment.circuit.lightCircuit
  		...
  		if (json.saltPPM != null) {
        	state.chlorinator = json.saltPPM
        	processChlorinator(state.chlorinator)
        //} else if (json.chlorinator != null) {
        //	state.chlorinator = json.chlorinator
        //    processChlorinator(state.chlorinator)
        }
//        else {
            //state.valves = json.valves
            //processValves(state.valves)
...
def parseAction(physicalgraph.device.HubResponse hubResponse) {
   ...
   if (json) {
      ...
      if (json.text.contains("POOL LIGHT")) { 
		  ...
		  log.info "spaHeatMode = ${state.shmStr}"	
          log.info "spaHeatModeBottom = ${state.shmStr}"	
          log.info "spaHeatMode = ${state.spaSetPoint}"	
          ...
          if (spaheatvalue == "idle") {
           ...
           loginfo "POOL toggle"
           state.POOL = json.status
           loginfo "${state.POOL}"
           sendEvent(name: "POOL", value: "${json.status}") 
           //sendEvent(name: "Main", value: "${json.status}")  
       }
   }
   state.DEBUG = 0
   //setAllPumps()
...
def processChlorinator(msg) {
    ...
    log.info("CHILD Parse Chlor ${json}")
    log.debug "msg.JSON.Salt: ${json.currentOutput}"
    log.debug "msg.JSON.Salt: ${json. name}"
    ...
    json.each {k, v ->        	         
         ...
         switch (k) {
            ...
            case "superChlorinate":
            	...
            	break
            case "status":
				log.debug "Status Info: $v"
            	break
            case "currentOutput":
                def sw = v==0 ? "off":"on"
                log.debug("SWITCH ${sw}")
                sendEvent(name: "chlorinate", value: sw, displayed:true ) 
                break;
        }
...
def processTemperatures(temperatures) {
    ...
    log.debug "state.SPAstate = ${state.SPAstate}"
    log.debug "state.POOLstate = ${state.POOLstate}"
    
    if (state.POOLstate?.is(1)) {
    	state.poolTempLK = temperatures.poolTemp
    }

	def poolTemp = state.SPAstate?.is(1) ? state.poolTempLK : temperatures.poolTemp
    ...
    log.info "state.phm = ${state.phm}"
    log.info "state.shm = ${state.shm}"
 
    //sendEvents for Temperature 
    sendEvent(name: "poolTemp", value: "${poolTemp}")
    //sendEvent(name: "POOL", value: "${poolTemp}")
    sendEvent(name: "spaTemp", value: "${spaTemp}")
    sendEvent(name: "airTemp", value: "${airTemp}")
    //sendEvent(name: "Main", value: "${state.POOL} ${airTemp}°")
    sendEvent(name: "freeze", value: "${freeze}")
              
    //sendEvents for Spa
    log.debug "state.shm = ${state.shm}"
    log.debug "state.shmStr = ${state.shmStr}"
    //if (state.shm > 0)
       sendEvent(name: "spaHeatMode", value: "${state.shmStr}")
    sendEvent(name: "spaHeatModeBottom", value: "${state.shmStr}")
...
def refresh() {
    ...
    //sendCommand("/all")   
    sendCommandCallBack("/chlorinator",'parseMain')
    sendCommandCallBack("/all",'parseMain')
    sendCommandCallBack("/device",'parseDevice')
    updateSchedule()
}
...
def spaModeToggle() {
    ...
    log.info "spaModeToggle"
	log.info "--------- ${state.shmStr} Toggle ----------"
    log.info "num = ${num}" 
...
def poolModeToggle() {  
    ...
    log.info "poolModeToggle"
	log.info "--------- ${state.phmStr} Toggle ----------"
    log.info "num = ${num}" 
