...
metadata {
	...
	definition (name: "Ecolink Firefighter", namespace: "acrosscable12814", author: "Eric Maycock", mnmn: "SmartThingsCommunity", vid: "158fb344-3246-332c-861c-28b2217aaead") { //, vid:"generic-smoke-co"
...
def createSmokeOrCOEvents(name, results) {
	def text = null
    log.debug("createSmokeOrCOEvents")
	switch (name) {
		case "smoke":
        ...
        case "detected":
            ...
            log.debug("$device.displayName covering was removed")
