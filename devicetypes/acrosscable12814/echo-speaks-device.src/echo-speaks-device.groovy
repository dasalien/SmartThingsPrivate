...
metadata {
    definition (name: "Echo Speaks Device", namespace: "acrosscable12814", author: "Dieter Rothhardt", mnmn: "SmartThingsCommunity", vid: "6918467a-4dc2-30f5-b08c-c5aae54ceb93") {
        ...
        capability "Refresh"
        capability "acrosscable12814.stopAllDevices"
        capability "acrosscable12814.doNotDisturb"
        capability "acrosscable12814.disconnectBluetooth"
        capability "acrosscable12814.followUpMode"
        capability "acrosscable12814.playWeather"
        capability "acrosscable12814.playSingASong"
        capability "acrosscable12814.playFlashBrief"
        capability "acrosscable12814.playGoodNews"
        capability "acrosscable12814.playTraffic"
        capability "acrosscable12814.playTellStory"
        capability "acrosscable12814.playFunFact"
        capability "acrosscable12814.playJoke"
        capability "acrosscable12814.sayWelcomeHome"
        capability "acrosscable12814.sayGoodMorning"
        capability "acrosscable12814.sayGoodNight"
        capability "acrosscable12814.sayCompliment"
        capability "acrosscable12814.resetQueue"
        capability "acrosscable12814.playCalendarToday"
        capability "acrosscable12814.playCalendarTomorrow"
        capability "acrosscable12814.playCalendarNext"
        capability "acrosscable12814.speechTest"
        capability "acrosscable12814.sendTestAnnouncement"
        capability "acrosscable12814.sendTestAnnouncementAll"
        capability "acrosscable12814.mediaSource"
        capability "acrosscable12814.currentAlbum"
        capability "acrosscable12814.currentStation"
        capability "acrosscable12814.alarmVolume"
        capability "acrosscable12814.btDevicesConnected"
        capability "acrosscable12814.btDevicesPaired"
        capability "acrosscable12814.deviceStyle"
        capability "acrosscable12814.onlineStatus"
        capability "acrosscable12814.alexaWakeWord"
        capability "acrosscable12814.supportedMusic"
        capability "acrosscable12814.lastSpeakCmd"
        capability "acrosscable12814.lastCmdSentDt"
        capability "acrosscable12814.lastVoiceActivity"
        capability "acrosscable12814.permissions"
        //capability "Sensor"
    ...
    preferences {
        ...
        section("Presets") {
            input "presetName1", "text", title: "Preset 1",  required: false, defaultValue: "80s music"
			input "presetName2", "text", title: "Preset 2",  required: false, defaultValue: "Rock ballads"
			input "presetName3", "text", title: "Preset 3",  required: false, defaultValue: "Top 10 Hits"
			input "presetName4", "text", title: "Preset 4",  required: false, defaultValue: "Some music"
			input "presetName5", "text", title: "Preset 5",  required: false, defaultValue: "Rock hits"
        }
    }
}
...
def installed() {
    ...
    sendEvent(name: "status", value: "standby") //stopped
    ...
    sendEvent(name: "doNotDisturb", value: "doNotDisturbOff")
    ...
    sendEvent(name: "stopAllDevices", value: "n/a")
    sendEvent(name: "disconnectBluetooth", value: "n/a")
    sendEvent(name: "playWeather", value: "n/a")
    sendEvent(name: "playSingASong", value: "n/a")
    sendEvent(name: "playFlashBrief", value: "n/a")
    sendEvent(name: "playTraffic", value: "n/a")
    sendEvent(name: "playTellStory", value: "n/a")
    sendEvent(name: "playFunFact", value: "n/a")
    sendEvent(name: "playJoke", value: "n/a")
    sendEvent(name: "sayWelcomeHome", value: "n/a")
    sendEvent(name: "sayGoodMorning", value: "n/a")
    sendEvent(name: "sayGoodNight", value: "n/a")
    sendEvent(name: "sayCompliment", value: "n/a")
    sendEvent(name: "resetQueue", value: "n/a")
    sendEvent(name: "playCalendarToday", value: "n/a")
    sendEvent(name: "playCalendarTomorrow", value: "n/a")
    sendEvent(name: "playCalendarNext", value: "n/a")
    sendEvent(name: "speechTest", value: "n/a")
    sendEvent(name: "sendTestAnnouncement", value: "n/a")
    sendEvent(name: "sendTestAnnouncementAll", value: "n/a")
    sendEvent(name: "currentAlbum", value: "n/a")
    sendEvent(name: "currentStation", value: "n/a")
    sendEvent(name: "btDeviceConnected", value: "n/a")
    sendEvent(name: "btDevicesPaired", value: "n/a")
    sendEvent(name: "deviceStyle", value: "n/a")
    sendEvent(name: "supportedMusic", value: "n/a")
    sendEvent(name: "lastCmdSentDt", value: "n/a")
    sendEvent(name: "lastVoiceActivity", value: "n/a")
    sendEvent(name: "permissions", value: "n/a")
...
def updated() {
	...
	Map preset = [:]
    preset?.id = "1"
	preset?.name = presetName1
	def presetJson = new groovy.json.JsonOutput().toJson(preset)

    Map preset2 = [:]
    preset2?.id = "2"
	preset2?.name = presetName2
	def presetJson2 = new groovy.json.JsonOutput().toJson(preset2)

    Map preset3 = [:]
    preset3?.id = "3"
	preset3?.name = presetName3
	def presetJson3 = new groovy.json.JsonOutput().toJson(preset3)

    Map preset4 = [:]
    preset4?.id = "4"
	preset4?.name = presetName4
	def presetJson4 = new groovy.json.JsonOutput().toJson(preset4)

    Map preset5 = [:]
    preset5?.id = "5"
	preset5?.name = presetName5
	def presetJson5 = new groovy.json.JsonOutput().toJson(preset5)

	def presets = "[${presetJson}, ${presetJson2}, ${presetJson3}, ${presetJson4}, ${presetJson5}]"
    
	log.debug("eeddir: presets: ${presets}")
...
def playbackStateHandler(playerInfo, isGroupResponse=false) {
    ...
    //log.debug("getPlaybackState: ${playerInfo}")
    String playState = playerInfo?.state == 'PLAYING' ? "playing" : "paused"//stopped
    String deviceStatus = "${playState}_${state?.deviceStyle?.image}"
    //log.debug "deviceStatus: ${deviceStatus}"
    //log.debug "status: ${playState?.toString()}"
    //log.debug "${isStateChange(device, "status", playState?.toString())}"
    //log.debug "${isStateChange(device, "deviceStatus", deviceStatus?.toString())}"
    ...
    //String trackImg = (playerInfo && playerInfo?.miniArt && playerInfo?.miniArt?.url) ? playerInfo?.miniArt?.url : ""
    //log.debug("eeddir: trackImg: ${trackImg}")
    if(isStateChange(device, "trackImage", trackImg?.toString())) {
    	//log.debug("eeddir: trackImage STATE CHANGE")
        isMediaInfoChange = true
    ...
    //log.debug("eeddir: mediaSource: ${mediaSource}")
    if(isStateChange(device, "mediaSource", mediaSource?.toString())) {
        //log.debug("eeddir: mediaSource STATE CHANGE")
        isMediaInfoChange = true
    ...
    if (isMediaInfoChange){
        //log.debug("eeddir: isMediaInfoChange STATE CHANGE")
        Map trackData = [:]
        ...
        if(playerInfo?.miniArt?.url) {trackData?.albumArtUrl = playerInfo?.miniArt?.url}
        else if(playerInfo?.mainArt?.url) { trackData?.albumArtUrl = playerInfo?.mainArt?.url }
        if(playerInfo?.provider?.providerName) { trackData?.mediaSource = playerInfo?.provider?.providerName }

		log.debug("eeddir: trackData: ${trackData}")
        sendEvent(name: "audioTrackData", value: new groovy.json.JsonOutput().toJson(trackData), display: false, displayed: false)
    }
    //log.debug("eeddir: time: ${playerInfo?.progress?.mediaLength}")
    //log.debug("eeddir: time: ${playerInfo?.progress?.mediaProgress}")
    sendEvent(name: "totalTime", value: playerInfo?.progress?.mediaLength?.toInteger())
    sendEvent(name: "elapsedTime", value: playerInfo?.progress?.mediaProgress?.toInteger())
...
def getBluetoothDevices() {
    ...
    if(isStateChange(device, "btDeviceConnected", curConnName?.toString())) {
        ...
        sendEvent(name: "btDevicesConnected", value: curConnName?.toString())
    }
}
...
def play() {
    ...
    if(isCommandTypeAllowed("mediaPlayer")) {
        ...
        if(isStateChange(device, "status", "playing")) {
            ...
            sendEvent(name: "musicPlayer", value: "playing")
        }
        triggerDataRrsh()
    }
}
...
def pause() {
    ...
    if(isCommandTypeAllowed("mediaPlayer")) {
        ...
        if(isStateChange(device, "status", "stopped")) {
            ...
            sendEvent(name: "musicPlayer", value: "paused")
        }
        triggerDataRrsh()
    }
}
...
def stop() {
    ...
    if(isCommandTypeAllowed("mediaPlayer")) {
        ...
        if(isStateChange(device, "status", "stopped")) {
            sendEvent(name: "status", value: "stopped", descriptionText: "Player Status is stopped", display: true, displayed: true)
            sendEvent(name: "musicPlayer", value: "stopped")
        }
        triggerDataRrsh()
    }
}
...
def playPreset(value) {
    if (value == "1") { searchMusic(presetName1,"AMAZON_MUSIC")}
    if (value == "2") { searchMusic(presetName2,"AMAZON_MUSIC")}
    if (value == "3") { searchMusic(presetName3,"AMAZON_MUSIC")}
    if (value == "4") { searchMusic(presetName4,"AMAZON_MUSIC")}
    if (value == "5") { searchMusic(presetName5,"AMAZON_MUSIC")}
}
...
def setFollowUpMode(value) {
    sendEvent(name: "followUpMode", value: value)
//    log.debug("setFollowUpMode(value) ${value}")
    
    if(value == "followUpModeOn") {
...
def setDoNotDisturb(value) {
    sendEvent(name: "doNotDisturb", value: value)
    //log.debug("setDoNotDisturb() ${value}")
    if(value == "doNotDisturbOn") {
...
def setVolumeSpeakAndRestore(volume, String msg, restVolume=null) {
    ...
    log.debug("setVolumeSpeakAndRestore(volume: $volume, msg: $msg, restVolume) command received...")
    if(msg) {
        if(volume != null && permissionOk("volumeControl")) {
...
def connectBluetooth(String btNameOrAddr) {
    ...
    if(isCommandTypeAllowed("bluetoothControl")) {
        ...
        if(curBtAddr) {
            ...
            sendEvent(name: "btDevicesConnected", value: btNameOrAddr)
...
def speak(String msg) {
    ...
    log.debug("speak() command received...")
    if(isCommandTypeAllowed("TTS")) {
